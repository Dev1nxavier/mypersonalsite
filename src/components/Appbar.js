            ...
            <AppBar position="sticky" sx={{ backgroundColor: 'transparent', opacity: '0.9', color: '#fff' }}>
                <Toolbar component="nav"
                    ...
                    <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'row' }}>
                        ...
                        >
                            <Typography variant='span' sx={{ color: '#b69351', fontWeight: 'bolder', fontSize: '2em' }}>S</Typography>
                            <Typography variant='h6' sx={{ position: 'relevant', left: -10, color: 'green' }}>greene</Typography>
                        </Box>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-around', mx: 10 }}>
                        <Link
                            ...
                            variant="body2"
                            href={`/`}
                            sx={{ color: '#b69351', px: 3, flexShrink: 0, textDecoration: 'none', fontFamily: 'Merienda', fontSize: '1.2em' }}
                        >
                            Home
                        </Link>
                        {pages.map((page, index) => (
                            <Link
                                ...
                                variant="body2"
                                href={`${page.page}`}
                                sx={{ px: 3, color: '#fff', flexShrink: 0, textDecoration: 'none', fontFamily: 'Merienda', fontSize: '1.2em' }}
                            >
                                {page.name}
                            </Link>
                        ))}
